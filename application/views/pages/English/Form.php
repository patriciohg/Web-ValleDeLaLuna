...
<body>
	...
	<nav class="navbar navbar-expand-lg navbar-light fixed-top" id="mainNav">
      <div class="container">
        <a  class="navbar-brand js-scroll-trigger" href="<?php echo site_url("English/English"); ?>">Inicio</a>
        ...
        <div class="collapse navbar-collapse" id="navbarResponsive">
          <ul class="navbar-nav ml-auto">
            <li class="nav-item">
              <a class="nav-link js-scroll-trigger" href="<?php echo site_url("English/English#about"); ?>">Informacion</a>
            </li>
            <li class="nav-item">
              <a class="nav-link js-scroll-trigger" href="<?php echo site_url("English/English#services"); ?>">Servicios</a>
            </li>
            <li class="nav-item">
              <a class="nav-link js-scroll-trigger" href="<?php echo site_url("English/English#portfolio"); ?>">Imagenes</a>
            </li>
            <li class="nav-item">
              <a class="nav-link js-scroll-trigger" href="<?php echo site_url("English/English#contact"); ?>">Contacto</a>
            </li>
            <li class="nav-item">
              <a class="nav-link js-scroll-trigger" href="<?php echo site_url("English/English#app"); ?>">Nuestra App</a>
            </li>
            <li class="nav-item">
              <a class="nav-link js-scroll-trigger" href="<?php echo site_url("English/English#Preguntas"); ?>">Preguntas frecuentes</a>
            </li>
...
<!--===============================================================================================-->
	...
	<script src="<?php echo base_url()?>/template/js/map-custom.js"></script>
<!--===============================================================================================-->
